...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (countPermissions == 0) {
            ...
            arr.add(new Permission("Get profile user", "/api/v1/profile", "GET",
                    "USERS"));
            arr.add(new Permission("Update profile user", "/api/v1/profile", "PUT",
                    "USERS"));
            arr.add(new Permission("Change password", "/api/v1/profile/change-password",
                    "PUT", "USERS"));

            arr.add(new Permission("Download a file", "/api/v1/files", "POST", "FILES"));
            arr.add(new Permission("Upload a file", "/api/v1/files", "GET", "FILES"));

            arr.add(new Permission("Upload avatar", "/api/v1/profile/avatar", "POST", "USERS"));
            arr.add(new Permission("Get file", "/api/v1/files/{fileName}", "GET", "FILES"));
            arr.add(new Permission("Upload file", "/api/v1/files/upload", "POST", "FILES"));
